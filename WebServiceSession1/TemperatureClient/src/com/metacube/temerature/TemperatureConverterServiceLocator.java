...
public class TemperatureConverterServiceLocator extends org.apache.axis.client.Service implements com.metacube.temerature.TemperatureConverterService {
    ...
    public com.metacube.temerature.TemperatureConverter getTemperatureConverter() throws javax.xml.rpc.ServiceException {
    ...
    public com.metacube.temerature.TemperatureConverter getTemperatureConverter(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.metacube.temerature.TemperatureConverterSoapBindingStub _stub = new com.metacube.temerature.TemperatureConverterSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.metacube.temerature.TemperatureConverter.class.isAssignableFrom(serviceEndpointInterface)) {
                com.metacube.temerature.TemperatureConverterSoapBindingStub _stub = new com.metacube.temerature.TemperatureConverterSoapBindingStub(new java.net.URL(TemperatureConverter_address), this);
                _stub.setPortName(getTemperatureConverterWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://temerature.metacube.com", "TemperatureConverterService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://temerature.metacube.com", "TemperatureConverter"));
        }
